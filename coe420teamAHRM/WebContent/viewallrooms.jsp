	...
	<div class="" style="height: 100vh; overflow: auto; max-height: 100%;">
		...
		<div class="container-fluid bg-light text-success pt-2 pb-1 shadow-sm">
			<h5><a href="Branch/back" class="text-dark">> Home </a> <a
					href="Rooms" class="text-dark">> Rooms > </a>View all rooms</h5>
		</div>
					...
					<%
							...
							if (rooms.size() == 0) {
								...
								for (Room room : rooms) {
									...
									out.println("<td>");
									out.println(room.getBeds().size()-room.getPatientIDs().size());
									out.println("</td>");
									out.println("<td>");
									List<String> patients = room.getPatientIDs();
									String pats = "";
									if(patients.isEmpty()){
