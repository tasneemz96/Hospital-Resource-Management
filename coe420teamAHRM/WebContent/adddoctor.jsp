...
<body>
	...
	<div class=""
		...
		<div class="container-fluid bg-light text-success pt-2 pb-1 shadow-sm">
			<h5>
				<a href="Branch/back" class="text-dark">> Home </a> <a
					href="Doctors" class="text-dark">> Doctors ></a> Add doctor
			</h5>
		</div>
		...
		<div
			...
			<form style="width: 28vw;" method="post" action="AddDoctor">
				...
				<div class="row pt-1">
					<div class="col"><a href="Doctors" class="text-decoration-none">
						<button type="button"
