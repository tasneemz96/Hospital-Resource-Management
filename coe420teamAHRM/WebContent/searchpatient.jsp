...
<body>
	<div class="" style="height: 100vh; overflow: auto; max-height: 100%;">
		...
		<div class="container-fluid bg-light text-success pt-2 pb-1 shadow-sm">
			<h5>
				<a href="Patients" class="text-dark">> Patients > </a>Search patient
			</h5>
		</div>
		...
		<div class="container-fluid pt-3">
			<div
				...
				<table class="table table-sm table-hover border">
					<thead class="thead-light">
						...
						<tr>
							<th>Insurance</th>
							<td>
								<%if(patient.isInsurance()){ out.println("Yes");
                            	}else{out.println("No");}%>
							</td>
						...
						<tr>
							<th>Bed no.</th>
							<td>
								<%if(patient.getBedNum()==-1){out.println("Unassigned");}
                            else{out.println(patient.getBedNum());}%>
							</td>
						</tr>
						<tr>
							<th>Watch</th>
							<td>
								<%if(patient.getWatchID()==-1){out.println("Unassigned");}
                            else{out.println(patient.getWatchID());}%>
							</td>
						</tr>
					</thead>
				</table>
				...
				<div class="row w-100 mt-3 mb-3" style="height: 50px;">
					<div class="col"> <a href="ViewAssignedEmployees" class="text-decoration-none">
						<button
							class="btn btn-outline-secondary btn-block rounded-0 h-100">View
							assigned doctors and nurses</button></a>
					</div>
				</div>
