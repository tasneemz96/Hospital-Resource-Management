...
<body>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height:500px;">
        <div classs="d-flex flex-row m-3 align-items-end" style="width:1050px;">
            <div class="col">
                <form method="post" action="SearchWatch">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control rounded-0" name="watchid" id="watchid" placeholder="Search watch by ID...">
                        <div class="input-group-append">
                          <button class="btn input-group-text rounded-0" type="submit"><i class="material-icons">search</i></button>
                        </div>
                      </div>
                </form>
            </div>
        ...
        <div class="d-flex flex-row m-3" style="width:1050px;height:90px;">
            <div class="col"><a href="ViewAllWatches" class="text-decoration-none">
                <button class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
                    <h4>View all watches</h4>
                </button></a>
            </div>
            <div class="col"><a href="AddWatch" class="text-decoration-none">
                <button class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
                    <h4>Add watch</h4>
                </button></a>
            </div>
            ...
            <div class="col"><a href="AssignWatch" class="text-decoration-none">
                <button class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
                    <h4>Assign watch</h4>
                </button></a>
            </div>
