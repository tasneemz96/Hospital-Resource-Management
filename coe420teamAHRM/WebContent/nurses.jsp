...
<%
    ...
    <div class="" style="height:100vh; overflow:auto; max-height:100%; width: 100vw;">
        ...
        <div class="container-fluid bg-light text-success pt-2 pb-1 shadow-sm">
            <h5><a href="Branch/back" class="text-dark"> Home ></a> Nurses</h5>
        </div>
        ...
        <div class="d-flex flex-column justify-content-center align-items-center h-75">
            <div classs="d-flex flex-row m-3 align-items-end" style="width:1050px;">
                <div class="col">
                    <form method="post" action="SearchNurse">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control rounded-0" placeholder="Search nurse by ID..." name = "nurseID">
                            <div class="input-group-append">
                                <button class="btn input-group-text rounded-0"><i
            ...
            <div class="d-flex flex-row m-3" style="width:1050px;height:90px;">
                <div class="col">
                <a href="ViewAllNurses" class="text-decoration-none">
                    <button class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
                        <h4>View all nurses</h4>
                    </button>
                    </a>
                </div>
                <div class="col">
                <a href="AddNurse" class="text-decoration-none">
                    <button class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
                        <h4>Add nurse</h4>
                    </button>
                    </a>
