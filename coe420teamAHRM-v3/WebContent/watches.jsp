...
HospitalBranch branch = branches.findBranch((int)request.getAttribute("branchID"));
request.getSession().setAttribute("branchID", branch.getBranchID());%>
	...
	<div class="container-fluid bg-light text-success pt-2 pb-1 shadow-sm">
		<h5>
			<a href="Branch/back" class="text-dark">> Home </a> > Watches
		</h5>
	</div>
	...
	<div
			...
			<div class="col">
				<form method="post" action="SearchWatch">
					<div class="input-group mb-3">
						<input type="text" class="form-control rounded-0" name="watchid"
							id="watchid" placeholder="Search watch by ID...">
		...
		<div class="d-flex flex-row m-3" style="width: 1050px; height: 90px;">
			<div class="col">
				<a href="ViewAllWatches" class="text-decoration-none">
					<button
			...
			<div class="col">
				<a href="AddWatch" class="text-decoration-none">
					<button
						class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
						<h4>Add watch</h4>
					</button>
			...
			<div class="col">
				<a href="AssignWatch" class="text-decoration-none">
					<button
						class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
						<h4>Assign watch</h4>
					</button>
