...
<body>
	<div
		...
		<div class="container-fluid bg-dark text-white pt-3 pb-2">
			...
			<h5><% HospitalBranch branch = (HospitalBranch)request.getAttribute("branch");
			out.println(branch.getBranchName()+", "+branch.getBranchLocation()); %></h5>
			<p><%out.println(branch.getBRID()); %></p>
		...
		<div
			...
			<div class="d-flex flex-row m-3" style="width: 800px; height: 90px;">
				...
				<div class="col"><a href="../Rooms" class="text-decoration-none">
					<button
						class="btn btn-lg btn-outline-secondary btn-block h-100 rounded-0">
						<h4>Rooms</h4>
					</button></a>
